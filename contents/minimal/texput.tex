...
plays audio (and video). It can be used to communicate with other
person(s), in real time.

\section{Supported platforms}

InterCom runs on Linux, Windows, and macOS. To abstract InterCom from
the audio driver, InterCom uses
...
a Python wrapper) to capture and play the audio. For example, in Linux, \texttt{sounddevice}, runs on the top of one of the following drivers:
\begin{enumerate}
