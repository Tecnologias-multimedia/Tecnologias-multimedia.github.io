...
\begin{enumerate}
\item The
  \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L146}{\texttt{record(chunk\_size)}}
...
\item
  \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L76}{\texttt{pack(chunk)}}
...
\item \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L89}{\texttt{send(packed\_chunk)}}
...
\item \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L96}{\texttt{receive()}},
...
\item \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L80}{\texttt{unpack(packed\_chunk)}} is (like the method
  \texttt{pack(chunk)}) a CPU-intensive step that transforms a
  possibly compressed chunk into a chunk of ``playable'' audio.

\item \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L161}{\texttt{play(chunk)}} renders the chunk. In general, this is an
