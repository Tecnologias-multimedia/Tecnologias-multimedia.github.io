...
InterCom is a desktop application that captures, sends, receives, and
plays audio (and video), in real time.
...
\begin{enumerate}
\item The
  \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L146}{\verb|record(chunk_size)|}
...
\item
  \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L76}{\verb|pack(chunk)|}
...
\item
  \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L89}{\verb|send(packed_chunk)|}
...
\item
  \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L96}{\verb|receive()|},
...
\item \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L80}{\verb|unpack(packed_chunk)|} is (like the method
  \texttt{pack(chunk)}) a CPU-intensive step that transforms a
  possibly compressed chunk into a chunk of ``playable'' audio.

\item \href{https://github.com/Tecnologias-multimedia/InterCom/blob/master/src/minimal.py#L161}{\verb|play(chunk)|} renders the chunk. In general, this is an
...
\item Always using the command line (do not modify the source code for
  this), change the value for the parameter \verb|--frames_per_chunk|,
  which by default is 1024. Do you notice any variation in the
  latency? And in the quality of the audio?
