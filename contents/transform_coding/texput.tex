...
\item \textbf{Determine the RD curves for a DWT~\cite{lee2019pywavelets}}:
%{{{

  Rebuild the RD curves considering also the removal of the temporal
  decorrelation. Use \verb|temporal_overlapped_DWT_coding.py| and the
...
\item \textbf{Determine the RD curves for the corresponding WPT~\cite{lee2019pywavelets}}:
%{{{

  Compare with \verb|temporal_overlapped_WPT_coding.py|. Use always the same graph.
