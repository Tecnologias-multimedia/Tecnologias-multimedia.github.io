...
want.\footnote{Some samples are stored in the \verb|data| directory of
...
to deal with the limitation of the throughput provided by the
transmission link. In general, we cannot expect that link will be able to transmit 1.5 Mbps uninterruptedly.
...
timeline (\href{https://tecnologias-multimedia.github.io/contents/latency/graphics/ping_timeline.svg}{Fig.~3}) and the Eq.~2 of the
\href{https://tecnologias-multimedia.github.io/contents/latency/}{previous
  milestone}.
