...
The frequency resolution of the HAS is limited. This basically means that two tonal sounds of similar frequency perceived at the same time almost sound the same that any of them, independtly. Moreover, the minimal frequency

\section{Dyadic decomposition}

\section{Dyadic-linear decomposition}
