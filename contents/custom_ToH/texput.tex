...
information that must be transmitted to your interlocutor so that he
...
\item %Let
  ...
  iteration the rest of subbands are zero), and while the noise
...
\verb|custom_ToH.txt|, when available. Use the frequencies corresponding to those defined in \verb|linear_ToH.py| and \verb|dyadic_linear_ToH.py|.
