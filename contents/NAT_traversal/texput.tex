...
\item Implement the UDP hole punching technique. Notice
  that the traffic generated by InterCom could be enough.
\end{enumerate}

This module should be tested in an environment where each InterCom
instance (\texttt{minimal.py}) runs in different NAT-ed LANs (Local
Area Networks, that probably are private). To do this, you have
