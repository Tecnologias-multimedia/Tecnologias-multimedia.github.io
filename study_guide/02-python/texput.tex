...
\href{https://docs.python.org/3/tutorial/modules.html#modules}{Python
  modules} written in Python \cite{python}. Therefore, you will need
an interpreter and know how to develop/run Python programs (modules
and
...
\end{verbatim}
  ...
  \item Alternatively (and reducing the chances of solving any possible
    issue), you can use the Python interpreter shipped with your
    OS. In this case, it is strongly recommended to use an specific
    Python
