...
\item Ff you don't have one or if you prefeer to create a new one,
  let's create a pair of keys. Open a terminal and write:
...
\item Revise
  ...
  without belonging to the developping organization, you must do some
...
\end{verbatim}        
  ...
  the InterCom. Notice however, that the action of clonning the InterCom
