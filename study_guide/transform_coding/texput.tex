...
\href{https://github.com/Tecnologias-multimedia/Tecnologias-multimedia.github.io/blob/master/study_guide/transform_coding/stereo_transforms_RD.ipynb}{notebook}.
%}}}
...
is much faster than the described in the previou paragraph, but it may
...
reconstruction of the signal ${\mathbf x}$ should be proportional to the
