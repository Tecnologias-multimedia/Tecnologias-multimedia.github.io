...
InterCom transmit a \href{https://en.wikipedia.org/wiki/Stereophonic_sound}{stereo} (left and right) signals. In most cases,
both channels
...
we can represent one of them (for example, the right channel) with
respect to the other (the left channel).
...
accumulation in a small number of
coefficients~\cite{sayood2017introduction}. \href{https://en.wikipedia.org/wiki/Correlation_and_dependence}{Correlation}
...
\href{https://www.mathsisfun.com/data/correlation.html}{correlation
  coefficient}~\cite{thinkstats}. In the case of InterCom, the random
variables are the two channels (left and right) of the
stereo \href{https://en.wikipedia.org/wiki/Pulse-code_modulation}{PCM
signal}~\cite{bosi2003intro}.
