\title{\href{https://www.ual.es/estudios/grados/presentacion/plandeestudios/asignatura/4015/40154321?idioma=zh_CN}{Tecnologías Multimedia} - Study Guide - Milestone 12: Intra-channel Decorrelation (Transform Coding)}

\maketitle

\section{Description}

Transform Coding is a basic signal decorrelating tool, used in most
multimedia (audio, image and vídeo) compression systems. The main
reasons for this are: (1) a good \href{}{coding gain}, (2) a
reasonable \href{}{computational complexity} (usually equal or smaller
than $O(N\log_2N)$, (3) \href{}{in-place} computation, and (4) that
are able to provide \href{}{multiresolution} representations. The
