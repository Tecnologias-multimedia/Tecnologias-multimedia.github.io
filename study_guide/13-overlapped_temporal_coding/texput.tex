...
of the overlapped areas (in the Fig.~\ref{fig:subbands}, $\{{\mathbf
  C}_{i-1}[-o:].{\mathbf l}^2, {\mathbf C}_{i+1}[:o].{\mathbf l}^2,
{\mathbf C}_{i-1}[-o:].{\mathbf h}^2, {\mathbf C}_{i+1}[:o].{\mathbf
  h}^2, {\mathbf C}_{i-1}[-o:].{\mathbf h}^1, {\mathbf
  C}_{i+1}[:o].{\mathbf h}^1\}$). To avoid this waste of bandwidth, we
