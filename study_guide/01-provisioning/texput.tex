...
running InterCom) is optional, but it is highly
recommend to do it because you'll receive technical support in a reasonable
time when you are in trouble. Futhermore, it is recommend to run
...
installation of Xubuntu 21.04 needs about 5GB). You will need also a
