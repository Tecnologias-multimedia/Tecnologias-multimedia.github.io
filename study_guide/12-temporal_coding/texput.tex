...
\item DWT performs a number of lifting steps, each one with
  ...
  \item An \textbf{update step}, which computes the ${\mathbf l}$
    ...
    errors. For the MST, we have that
    \begin{equation}
...
levels $l$ of the DWT can have a high impact on the
amount of energy concentration achieved by the DWT, and therefore, on
the efficiency of coding system. Show such impact.
